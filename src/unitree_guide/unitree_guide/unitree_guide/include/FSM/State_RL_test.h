...
public:
    ...
    void publishRlModeReady(bool ready);
    void publishPolicyCmdInputAudit();
    void publishAngularActuationTelemetry(
...
private:
    ...
    ros::Publisher rl_mode_ready_pub_;
    ros::WallTime last_rl_mode_publish_wall_;
    ros::Publisher selected_policy_pub_;
    std::string selected_policy_name_;
    std::string selected_policy_path_;
    std::string selected_policy_sha256_;
    ros::Publisher stair_policy_cmd_input_pub_;
    double stair_policy_cmd_input_rate_hz_ = 10.0;
    ros::WallTime last_stair_policy_cmd_input_wall_;
    ros::Publisher angular_actuation_state_pub_;
    bool angular_actuation_telemetry_enabled_ = false;
    double angular_actuation_telemetry_rate_hz_ = 10.0;
    ros::WallTime last_angular_actuation_telemetry_wall_;
